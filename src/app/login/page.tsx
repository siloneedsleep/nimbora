  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0e1a] px-4">
      <form onSubmit={handleSubmit} className="glass rounded-3xl p-8 w-full max-w-md">
        <h1 className="font-display text-3xl font-semibold text-center mb-8">Login</h1>
        ...
        <p className="text-gray-400 text-center mt-4">
          Chưa có tài khoản? <a href="/signup" className="text-sky-300 hover:underline">Sign Up</a>
        </p>
      </form>
    </div>
  );
